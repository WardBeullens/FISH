...
#define HELPER_R0(helper)    				 (HELPER_COMMITMENT_RANDOMNESS(helper) + SETUPS*3*SEED_BYTES)
...
#define RESPONSE_VECTS(rsp) (RESPONSE_COMMITMENT_RANDOMNESS(rsp) + EXECUTIONS*2*SEED_BYTES)
